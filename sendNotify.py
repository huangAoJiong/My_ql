...
push_config = {
    ...
    'GOBOT_URL': '',#http://192.168.192.31:25733/send_group_msg',#'http://192.168.192.31:25733/send_private_msg',                    # go-cqhttp
                                        # 推送到个人QQ：http://127.0.0.1/send_private_msg
                                        # 群：http://127.0.0.1/send_group_msg
    'GOBOT_QQ': '',#group_id=455219596',                     # go-cqhttp 的推送群或用户
    ...
    'PUSH_KEY': '',#'SCT226633TYmn4gkvTcvjr6Sdz7RkOPsop',                     # server 酱的 PUSH_KEY，兼容旧版与 Turbo 版

    'PUSH_PLUS_TOKEN': '',      # '8f6bb548dc3349d3928effb23b501e2e',              # push+ 微信推送的用户令牌
    ...
    'TG_BOT_TOKEN': '',#'6013675974:AAHhih9lRdbsWJBF_wZh8yml_xFlRZyfRh4',                 # tg 机器人的 TG_BOT_TOKEN，例：1407203283:AAG9rt-6RDaaX0HBLZQq0laNOh898iFYaRQ
    'TG_USER_ID': '',#'6262421007',                   # tg 机器人的 TG_USER_ID，例：1434078534
    'TG_API_HOST': '',                  # tg 代理 api
    'TG_PROXY_AUTH': '',                # tg 代理认证参数
    'TG_PROXY_HOST': '',                # tg 机器人的 TG_PROXY_HOST
    'TG_PROXY_PORT': '',                # tg 机器人的 TG_PROXY_PORT

    'CHAT_ACCESS_TOKEN': '',            # 微信开发平台token
    ...
    body_jsons = [
        {
            ...
            "template_id": "Ax5UaBu6oJ_DybHKKGg_2-7u2kA5hrNYVPmEAVrQ1I4",  # 恩山论坛账户详情
            "topcolor": "#FF0000",
            "data": {
                "thing1": {
                    "value": f"{title}",
        ...
        {
            "touser": "oB0ix6qF-Pip5YV9VWZGGsfUwmc4",
            "template_id": "oQuDVvE4oUeNZQoYtQ9lKI6Jb37Y0ptn_dPHAkgxQCA",  # didi
            "topcolor": "#FF0000",
            "data": {
                "thing1": {
                    "value": f"{title}",
        ...
        {
            "touser": "oB0ix6qF-Pip5YV9VWZGGsfUwmc4",
            "template_id": "w-DRk66l-KFfLfC-afRDwnyNndjPb1JoXUrhwJekJZU",  # didi
            "topcolor": "#FF0051",
            "data": {
                "thing1": {
                    "value": f"{title}",
